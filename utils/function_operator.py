...
def crossover_tree_branch_swap(tree, donor, max_height):
    ...
    nodes2, depth_node2 = __GetCandidateNodesAtUniformRandomDepth_crossover(nodes2_subtree, max_height - depth_node1)
